...
public class MecRedQuarryOrig extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        phoneCam.setPipeline(new MecRedQuarryOrig.StageSwitchingPipeline()); // Different stages
    ...
    static class StageSwitchingPipeline extends OpenCvPipeline
    {
        ...
        private MecRedQuarryOrig.StageSwitchingPipeline.Stage stageToRenderToViewport = MecRedQuarryOrig.StageSwitchingPipeline.Stage.detection;
        private MecRedQuarryOrig.StageSwitchingPipeline.Stage[] stages = MecRedQuarryOrig.StageSwitchingPipeline.Stage.values();
